...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ContactRow>{
    ...
    @NonNull
    @Override
    public ContactRow onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
    ...
    public class ContactRow extends RecyclerView.ViewHolder {
        ...
        public ContactRow(View itemView) {
            ...
            messageButton = (Button) itemView.findViewById(R.id.msg_button);
        }
    }
}
